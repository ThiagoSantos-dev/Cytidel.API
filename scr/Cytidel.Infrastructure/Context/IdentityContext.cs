...
namespace Cytidel.Infrastructure.Context;
//this gives the context of the user that is accessing the api
internal class IdentityContext : IIdentityContext
{
    ...
    internal IdentityContext(string id, string role, bool isAuthenticated, IDictionary<string, string> claims)
    {
        ...
        IsAdmin = Role.Contains("admin", StringComparison.InvariantCultureIgnoreCase);
